...
#define SWIGTYPE_p_MazeFinder swig_types[20]
...
static swig_lua_attribute swig_MazeFinder_cls_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_MazeFinder_cls_methods[] = {
    {0,0}
};
static swig_lua_const_info swig_MazeFinder_cls_constants[] = {
    {0,0,0,0,0,0}
};
static swig_lua_class *swig_MazeFinder_bases[] = {0,0};
static const char *swig_MazeFinder_base_names[] = {"Actor *",0};
static swig_lua_class _wrap_class_MazeFinder = { "MazeFinder", &SWIGTYPE_p_MazeFinder,_wrap_new_MazeFinder, swig_delete_MazeFinder, swig_MazeFinder_methods, swig_MazeFinder_attributes, { "MazeFinder", swig_MazeFinder_cls_methods, swig_MazeFinder_cls_attributes, swig_MazeFinder_cls_constants }, swig_MazeFinder_bases, swig_MazeFinder_base_names };
