...
public:
	...
	std::vector<TradingStruct> GetSpecificTradeRoutesFromCity(const std::weak_ptr<City> _city, const std::map<std::string, int> inventory, const int _profitabilityBias = 0, const float _maxDistance = 0.0f, float _maxThreat = -1.0f);
